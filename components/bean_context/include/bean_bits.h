...
const static EventBits_t BEAN_SYSTEM_INIT_OK               = BIT0; // Indicates the system is fully initialized, this bit can be used to synchronize the start of other tasks
...
const static EventBits_t BEAN_SYSTEM_BATTERY_CRITICAL      = BIT3; // Indicates the battery very low, device should be turned off
